    ...
    <main className="min-h-screen grid-bg">
      ...
      <article className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="mt-6 flex items-center justify-center gap-3">
          ...
          <a
            href={`https://t.me/share/url?url=${encodeURIComponent("https://taranoid.com/learn/case/pippinu")}&text=${encodeURIComponent("Gerçek bir rug pull'un anatomisi: PIPPINU nasıl %97 kaybettirdi?")}`}
          ...
          <a
            href={`https://twitter.com/intent/tweet?text=${encodeURIComponent("Gerçek bir rug pull'un blockchain analizi: PIPPINU vakası. 380 sahte cüzdan, %97 kayıp — Taranoid bunu önceden gördü:")}&url=${encodeURIComponent("https://taranoid.com/learn/case/pippinu")}`}
            target="_blank" rel="noopener noreferrer"
            className="metric-badge hover:opacity-80 transition-opacity"
