...
export default function HolderChart({ top10Concentration, holderCount }: HolderChartProps) {
        ...
        <div className="relative flex-shrink-0" style={{ width: 160, height: 160 }}>
          <svg width="160" height="160" viewBox="0 0 160 160" className="transform -rotate-90">
            ...
            <circle
              ...
              style={{ filter: `drop-shadow(0 0 10px ${color}60)`, transition: "stroke-dashoffset 1.6s ease-out" }}
            />
          </svg>
        ...
        <div className="flex-1 space-y-4">
          <div>
            <div className="flex justify-between items-center mb-1.5">
              <span className="text-xs font-medium" style={{ color: "var(--cg-text-muted)" }}>Top 10 Holder</span>
              <span className="text-xs font-bold font-mono" style={{ color }}>%{top10Pct}</span>
            </div>
